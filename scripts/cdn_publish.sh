...
then
  ...
  cp packages/gravity-ui-web/dist/* ${cdnCurrentVersionGravityDir}/${version}
  ...
  cp packages/gravity-ui-web/dist/* ${cdnLatestVersionsGravityDir}/v${majorVersion}.x
  mkdir -p ${cdnLatestVersionsGravityDir}/latest
  cp packages/gravity-ui-web/dist/* ${cdnLatestVersionsGravityDir}/latest
